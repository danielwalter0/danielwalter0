...
**Computer Science student @ Brunel University of London** — heading into my second year.

I enjoy building things from the ground up, solving problems, and holding myself to high standards.
I learn best by diving in and figuring things out.
...
`OOP` · `REST API Design` · `Agile` · `Version Control`
...
### 🔹 [Frontier Stack](https://github.com/danielwalter0/frontier-stack)
